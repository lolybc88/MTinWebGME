 ...
 * <ul>
 *   <li>{@link org.xtext.example.webgme.mTL.impl.FilterImpl#getExpr <em>Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FilterImpl extends MinimalEObjectImpl.Container implements Filter
{
  ...
  {
    return MTLPackage.Literals.FILTER;
  }
  ...
  public NotificationChain basicSetExpr(ComplexExpression newExpr, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MTLPackage.FILTER__EXPR, oldExpr, newExpr);
  ...
  public void setExpr(ComplexExpression newExpr)
  {
    if (newExpr != expr)
    {
      ...
      if (expr != null)
        msgs = ((InternalEObject)expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MTLPackage.FILTER__EXPR, null, msgs);
      if (newExpr != null)
        msgs = ((InternalEObject)newExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MTLPackage.FILTER__EXPR, null, msgs);
      msgs = basicSetExpr(newExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MTLPackage.FILTER__EXPR, newExpr, newExpr));
  }
