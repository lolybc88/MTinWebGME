                ...
                if (self.isMetaTypeOf(elem, self.META['Class']) === true) {
                 	var c = elem;
                                     ...
                                     var trace1 = {
                	        				...
                	        				a = self.core.createNode({
                                            parent: trgModelNode,
                                            base: self.META.Attribute
                                        });
                                        self.core.setAttribute(a, 'name', 'Attribute');
                                        //--
                		                        
                		                        var nav0 = c;
                		                        
                		                        var nav0 = self.core.getAttribute(nav0, 'nname');
                		                        var nav0 = nav0 + ' derived'; 
                		                        var left = nav0;
                		                        var exp = left;
                		                        self.core.setAttribute(a, 'nname', exp);
                		                        //--
                                        //--
                                        self.core.setRegistry(a, 'position', {x: 50, y: 100});
                                        self.trgElements[self.core.getPath(a)] = a;
                                        trace1.srcElementIds.push(key);
                                        trace1.trgElementId = self.core.getPath(a);
                                        trace1.ruleName = 'Class2Table';
                                        trace1.position = 2;
                ...
                if (self.isMetaTypeOf(elem, self.META['Class']) === true) {
                 	var c = elem;
                                     	...
                                     	/* Elements creation */
                		                        ...
                		                        var nav0 = self.navigateToNode(nav0, 'super');
                		                        var left = nav0;
                		                        var right = null;
                		                        var condition = left	
                		                        !=
                		                        ...
                		                        //--
                		                        a = self.resolve(elem, 2);
                		                        var left = c;
                		                        var left = left;
                		                        				var left = self.resolve(left, 1);
                		                        var exp = left;
                		                        self.setParent(a, exp);
                		                        //--
                                     	}
